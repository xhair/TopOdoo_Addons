...
!function (a, b) {
    ...
    //switch ("openEnterpriseChat" == a && (b.errCode = b.err_code), delete b.err_code, delete b.err_desc, delete b.err_detail, d = b.errMsg, d || (d = b.err_msg, delete b.err_msg, d = h(a, d), b.errMsg = d), c = c || {}, c._complete && (c._complete(b), delete c._complete), d = b.errMsg || "", C.debug && !c.isInnerInvoke && alert(JSON.stringify(b)), e = d.indexOf(":"), f = d.substring(e + 1)) {
    function g(a, b, c) {
        var d, e, f;
        switch ("openEnterpriseChat" == a && (b.errCode = b.err_code), delete b.err_code, delete b.err_desc, delete b.err_detail, d = b.errMsg, d || (d = b.err_msg, delete b.err_msg, d = h(a, d), b.errMsg = d), c = c || {}, c._complete && (c._complete(b), delete c._complete), d = b.errMsg || "", C.debug && !c.isInnerInvoke && JSON.stringify(b), e = d.indexOf(":"), f = d.substring(e + 1)) {
            case"ok":
    ...
    if (!a.jWeixin)return o = {
        ...
        config: function (a) {
            ...
            c(o.consumeAndShareCard, {consumedCardId: a.cardId, consumedCode: a.code}, a)
        }, chooseWXPay: function (a) {
            c(o.chooseWXPay, f(a), a)
        }, openEnterpriseRedPacket: function (a) {
            c(o.openEnterpriseRedPacket, f(a), a)
        }, startSearchBeacons: function (a) {
            c(o.startSearchBeacons, {ticket: a.ticket}, a)
        }, stopSearchBeacons: function (a) {
            c(o.stopSearchBeacons, {}, a)
        }, onSearchBeacons: function (a) {
            d(o.onSearchBeacons, a)
