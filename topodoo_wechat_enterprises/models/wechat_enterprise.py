                    ...
                    if 'code' in kw and 'state' in kw:  # 检查是否取得了code
                        ...
                        if account:  # 是否取得了微信企业号通讯录的账号
                            ...
                            if user:  # 是否取得了用户
                                ...
                                # return request.render('topodoo_wechat_enterprises.wechat_warning',{'title':u'警告','content':u'用户不存在.'})
                                return " "
                        else:
                            _logger.warning('微信企业号验证失败.')
                            return request.render('topodoo_wechat_enterprises.wechat_warning',
                        ...
                        value = {"url": url}
                        return request.render("topodoo_wechat_enterprises.Transfer", value)
                else:
